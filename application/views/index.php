...
<html>
  <head>
	...
	<link href="<?php echo $this->config->item('css_path'); ?>style2.css" rel="stylesheet" media="screen">
	<link href="<?php echo $this->config->item('css_path'); ?>chosen.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $this->config->item('css_path'); ?>style-metronic.css" rel="stylesheet" type="text/css">
