...
class Jenis_pajak extends CI_Controller {
	...
	public function index()
	{
		...
		$game['table'] = 'tbl_jp';										#--- mendefinisikan nama table yang dipanggil ke jqgrid
		...
		$game['jqgrid_at_name'] = array(								#--- mendefinisikan nama kolom pada jqgrid
				$game['kolom'][1] => 'jpid',							#    didefnikan  berdasarkan urutan kolom 
				$game['kolom'][2] => 'Kode Akun',						    #    misalkan kolom[1] namanya ID, kolom[2] namanya Nama, dst
				$game['kolom'][3] => 'Kode Jenis',												
				$game['kolom'][4] => 'Jenis Pajak',												
				$game['kolom'][5] => 'Keterangan',												
		);																
...
/* End of file jamwajib.php */
/* Location: ./application/controllers/jamwajib.php */