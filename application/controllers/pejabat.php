...
class Pejabat extends CI_Controller {
	...
	public function index()
	{
		...
		$game['table'] = 'tbl_pejabat';										#--- mendefinisikan nama table yang dipanggil ke jqgrid
		...
		$game['jqgrid_at_name'] = array(								#--- mendefinisikan nama kolom pada jqgrid
				...
				$game['kolom'][2] => 'Nama ',						    #    misalkan kolom[1] namanya ID, kolom[2] namanya Nama, dst
				$game['kolom'][3] => 'NIP',												
				$game['kolom'][4] => 'Jabatan',												
				$game['kolom'][5] => 'Eselon',												
				$game['kolom'][6] => 'Status',												
		);																
		$game['jqgrid_at'] = array(										#--- mendefinisikan attribut kolom pada jqgrid
			...
			$game['kolom'][6] => 'editable:true,width:50,sorttype:"int",edittype:"checkbox"'
		);
